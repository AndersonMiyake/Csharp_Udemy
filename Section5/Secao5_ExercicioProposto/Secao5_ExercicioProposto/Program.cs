    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            char initialDeposit = Convert.ToChar(Console.ReadLine());

            BankAccount ba = new BankAccount(accNumber, holder);

            if (initialDeposit.Equals('y'))
            {
                Console.Write("Enter the value of the initial deposit: ");
                ba.Deposit(double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture));
            }
            ...
            ba.Withdrawal(double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture));
            Console.WriteLine("Updated Account Details: ");
            Console.WriteLine(ba);
